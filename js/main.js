    ...
    if ($(this).closest(".modal").attr("id") == "create-order") {
        $(this).closest(".modal").find(".period-field").append(
            ...
            <div class="col-sm-12 nopadding period-row"> 
                            <div class="col-sm-2 period-margin"><input type="text" name="label[]" class="form-control" placeholder=""  /></div> 
                            <div class="col-sm-2 period-margin"><input type="text" name="duedate[]" class="form-control datepick due-date" placeholder="mm/dd/yyyy"  /></div> 
                            <div class="col-sm-2 period-margin"><input type="number" name="days[]" class="form-control days-input" min="0" datepick" placeholder="Days"  /></div> 
        ...
        $(this).closest(".modal").find(".period-field").append(
            `<div class="col-sm-12 nopadding period-row"> 
            <div class="col-sm-2 period-margin"><input type="text" name="label[]" class="form-control" placeholder="" v /></div> 
            <div class="col-sm-2 period-margin"><input type="text" name="duedate[]" class="form-control datepick due-date" placeholder="mm/dd/yyyy"  /></div> 
            <div class="col-sm-2 period-margin"><input type="number" name="days[]" class="form-control days-input" min="0" datepick" placeholder="Days"  /></div> 
            <div class="col-sm-2 period-margin">    
                <div class="input-icon input-icon-left"> 
