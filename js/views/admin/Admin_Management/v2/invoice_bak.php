<div class="content-wrapper" style="min-height:800px;">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <table id="dttable" class="table table-bordered table-hover" data-detail-url="<?echo base_url?>dashboard/v2/Invoice_Detail">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Order Name</th>
    ...
    ?>
        ...
        ?><a class="btn btn-primary add-payment" data-refresh="true" data-action="<?echo base_url()?>dashboard/v2/Add_Payment" data-method="POST" data-form='invoice_id=<?echo $invoice->id?>'>Add Payment</a>&nbsp<?php
    } ?>
                                <a class="btn btn-primary download-invoice" href="<?echo base_url()?>dashboard/v2/Download_Invoice?invoice_id=<?echo $invoice->id?>" target="_blank">Download PDF</a>&nbsp
