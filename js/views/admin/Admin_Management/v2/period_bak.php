<div class="content-wrapper" style="min-height:800px;">
    ...
    ?>
                        <tr data-id="<?php echo $period->id?>">
                            ...
                            <td><?php echo $period->product_name ?></td>
              ...
              <div class="col-sm-12">
                ...
                <div class="col-sm-9 period-field">
                    ...
                    <div class="col-sm-12 nopadding period-row">
                        ...
                        <div class="col-sm-3 period-margin"><input type="text" name="duedate[]" class="form-control datepick" placeholder="" value="" readonly/></div>
                        <div class="col-sm-4 period-margin">
                            <div class="input-icon input-icon-left">
                              <i>IDR</i>
                                  <input type="text" name="price[]" class="form-control" placeholder="0.0" value="" /></div>
                            </div>
                            <div class="col-sm-1 period-margin period-delete-icon"><i class="fa fa-ban"></i>
                        </div>
                    </div>
                    <div class="col-sm-12 nopadding period-row">
                        <div class="col-sm-3 period-margin"><input type="text" name="label[]" class="form-control" placeholder="" value="" /></div>
