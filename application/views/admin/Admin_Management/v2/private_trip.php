      ...
      <div class="modal-body">
        ...
        <?php
            ...
            <div class="col-sm-12">
              ...
              <div class="col-sm-9">
                  <div>
                    <input type="number" step="100000" name="period[down_payment]" class="form-control" placeholder="0.0" value="">
                  </div>
              </div>
            </div>
            <div class="col-sm-12">
    ...
    <?php echo form_open("dashboard/v2/Update_Private_Trip", 'id="form-private-trip-update"'); ?>
      <div class="modal-body">
          <div class="col-xs-12 custom-input">
              ...
              <input type="hidden" name="period_id" class="form-control" placeholder="" value="">
              <div class="col-sm-12">
                <label for="order_id" class="col-sm-3 control-label">Package</label>
                <div class="col-sm-9">
                  <select name="package_id" class="form-control" style="">
