...
<body>
  ...
  <div class="container">
    <div class="navbar-header">
      ...
      <a href="<?php echo base_url(); ?>./" class="navbar-brand"><img src="<?php echo base_url(); ?>images/peponi-logo.png" height="100px;" alt="peponi" style="padding:0; margin:-20px; margin-top:-35px;"></a>
    </div>
