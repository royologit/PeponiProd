            ...
            <div class="col-md-12">
                ...
                <div class="col-md-8">
                    <table class='table table-responsive borderless'>
                        <tr>
                            <th>Tagihan</th>
                            <td><?php echo currency_format($invoice->total-$invoice->discount); ?></td>
                        </tr>
                        <tr>
                            <th>Payment Fee</th>
                        ...
                        <tr>
                            <th>Total Tagihan </th>
                            <td class='price-text' id="total_tagihan"><?php echo currency_format($invoice->total-$invoice->discount); ?></td>
                        </tr>
                    </table>
                </div>
            </div>
            <input type="hidden" name="invoice_id" value="<?php echo $invoice->id; ?>">
            <input type="hidden" name="total" id="total" value="<?php echo $invoice->total-$invoice->discount; ?>">
