              ...
              <p>${deskripsi}</p>
                <div class="row">
                    ...
                    <div class="form-group">
                            ...
                            <select labels="Gender" header_id="collapse-${$('#form-pemesanan .panel-default').size()}"  autocomplete="off" class="form-control" id="gender" name="gender[]">
                            ...
                            <label class="error-msg error-msg-gender"></label>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                       ...
                       element+=``
                       element+=`<input type="hidden" value="${age[0].age_group_id}">`
